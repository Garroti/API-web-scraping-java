...
import com.gabryelmacedo.scrapingbrasileiraoapi.dto.PartidaDTO;
import com.gabryelmacedo.scrapingbrasileiraoapi.dto.PartidaGoogleDTO;
import com.gabryelmacedo.scrapingbrasileiraoapi.dto.PartidaResponseDTO;
...
import com.gabryelmacedo.scrapingbrasileiraoapi.respository.PartidaRepository;
...
public class PartidaService {
	...
	public Partida buscarPartidaPorId(Long id) {
		return partidaRepository.findById(id).orElseThrow(() -> new NotFoundException("Nenhuma partida encontrada com o id " + id));
	}
	...
	public void alterarPartida(Long id, PartidaDTO dto) {
		...
		if(!exists) {
			throw new NotFoundException("Não foi possivel atualizar a partida, id " + id + " não encontrado");
		}
	...
	public List<Partida> listarPartidasPeriodo() {
		return partidaRepository.listarPartidasPorPeriodo();
	}
